...

      {
        <div>
          ...
          {listItem.map((data) => {
            ...
            return(
                <div key={data.card.info.id} className="p-2 m-2 border-b-2">
                    <div className="flex">
                    ...
                    <div>
                        <img className="w-28 h-24 object-cover object-center rounded-6" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_208,h_208,c_fit/"+imageId}/>
                    </div>
                </div>
            )
          })}
