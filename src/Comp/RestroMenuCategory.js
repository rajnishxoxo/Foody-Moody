                ...
                <div className="flex flex-row justify-evenly items-center">
                  ...
                  >
                    <div>
                      ...
                      <div>
                        <p className=" text-left m-2 font-medium text-gray-700 break-words ">Rs {price / 100}</p>
                      </div>
                  ...
                  <div className="flex">
                      ...
                      <button className="w-14 left-1/2 bottom-8 transform -translate-x-3/2  -translate-y-7/2 z-10  p-2 bg-gray-100 shadow-lg  text-green-700 h-full cursor-pointer rounded ">Add+</button>
